...
/** Using period_init() function to initialize the callback.
 *  This initialization function is only called once before starting the RTOS
 */
...
/**
 * Below is the changed periodic callback function running at 100ms
 * The argument 'count' is the number of times each periodic task is called.
 */
